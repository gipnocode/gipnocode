    ...
    (Z.fn.dateRangePicker = function (p) {
        ...
        r = (function () {
          {
            if ("auto" == p.language) {
              ...
              return e && (e = e.toLowerCase()) in Z.dateRangePickerLanguages
                ? Z.dateRangePickerLanguages[e]
                : Z.dateRangePickerLanguages.default;
            }
            return p.language && p.language in Z.dateRangePickerLanguages
      ...
      return (
        ...
        function () {
                ...
                p.showTopbar &&
                  ...
                  p.customTopBar
                    ? ("function" == typeof p.customTopBar &&
                        (p.customTopBar = p.customTopBar()),
                      (t +=
                        '<div class="custom-top">' + p.customTopBar + "</div>"))
                    : ((t +=
          ...
          m
            .find(".default-top")
            .html(n.replace(/\%d/, p.minDays).replace(/\%d/, p.maxDays)),
            p.singleMonth
        ...
        Z(this).data("dateRangePicker", {
          ...
          setDateRange: function (e, t, a) {
            "string" == typeof e &&
              "string" == typeof t &&
              ((e = Q(e, p.format).toDate()), (t = Q(t, p.format).toDate())),
              T(e, t, a);
          },
          clear: function () {
            (p.start = !1),
            ...
            e.left < 460
              ? m.css({
                  top:
                    e.top +
                    Z(n).outerHeight() +
                    parseInt(Z("body").css("border-top") || 0, 10),
                  left: e.left,
                })
              : m.css({
                  top:
        ...
        if (!e.hasClass("invalid")) {
          ...
          if (
            ...
            p.singleDate
              ...
              : "week" === p.batchMode
              ? "monday" === p.startOfWeek
                ? ((p.start = Q(parseInt(t)).startOf("isoweek").valueOf()),
                  (p.end = Q(parseInt(t)).endOf("isoweek").valueOf()))
                : ((p.end = Q(parseInt(t)).endOf("week").valueOf()),
                  (p.start = Q(parseInt(t)).startOf("week").valueOf()))
              ...
              : "month" === p.batchMode
              ? ((p.start = Q(parseInt(t)).startOf("month").valueOf()),
                (p.end = Q(parseInt(t)).endOf("month").valueOf()))
              : (p.start && p.end) || (!p.start && !p.end)
              ? ((p.start = f(t)), (p.end = !1))
              : p.start && ((p.end = v(t)), p.time.enabled && h("end", p.end)),
            p.time.enabled &&
              (p.start && h("start", p.start), p.end && h("end", p.end)),
      ...
      function k(e) {
        if (((e = parseInt(e, 10)), p.startDate && F(e, p.startDate) < 0))
          return !1;
          ...
          p.start &&
            ...
            m.find(".day.toMonth.valid").each(function () {
              k(parseInt(Z(this).attr("time"), 10))
                ? Z(this).addClass("valid tmp").removeClass("invalid")
                : Z(this).addClass("invalid tmp").removeClass("valid");
            }),
          !0
        );
      }
      ...
      function D(e) {
        ...
        s &&
          ...
          i &&
            o.isSameOrAfter(i) &&
            (o = i.add(p.singleMonth || "month1" !== n ? 0 : -1, "month")),
          z(o, n),
          "month1" === n
            ? (p.stickyMonths || Q(o).isSameOrAfter(p[r], "month")) &&
              z(Q(o).add(1, "month"), r)
            : (p.stickyMonths || Q(o).isSameOrBefore(p[r], "month")) &&
              z(Q(o).add(-1, "month"), r),
          I();
      }
      function x() {
      ...
      function M() {
        ...
        p.singleDate
          ...
          p.batchMode &&
            ((p.start && p.startDate && F(p.start, p.startDate) < 0) ||
      ...
      function T(e, t, a) {
        ...
        if (
          ...
          return (
            z(p.startDate, "month1"), z(H(p.startDate), "month2"), void I()
          );
        (p.start = e.getTime()),
          (p.end = t.getTime()),
          ...
          p.stickyMonths &&
            ...
            ((e = R(e)), (t = R(t))),
          p.stickyMonths ||
            (0 === L(e, t) && (p.lookBehind ? (e = R(t)) : (t = H(e)))),
          z(e, "month1"),
          z(t, "month2"),
          I(),
          M(),
        ...
        (p.start || p.end) &&
          (m.find(".day").each(function () {
            ...
            p.time.enabled &&
              ...
              p.start && Q(t).format("YYYY-MM-DD") == Q(e).format("YYYY-MM-DD")
                ? Z(this).addClass("first-date-selected")
                : Z(this).removeClass("first-date-selected"),
              p.end && Q(a).format("YYYY-MM-DD") == Q(e).format("YYYY-MM-DD")
        ...
        if (!p.alwaysOpen) {
          var e = function () {
            Z(n).data("date-picker-opened", !1),
              Z(n).trigger("datepicker-closed", { relatedTarget: m });
          };
      ...
      function U(e) {
        ...
        (t = e),
          (a = n[0]).contains(t.target) ||
            t.target == a ||
            (null != a.childNodes && 0 <= Z.inArray(t.target, a.childNodes)) ||
            (m.is(":visible") && N());
      }
    });
});
